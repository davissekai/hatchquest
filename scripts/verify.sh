...
#
# Checks in order:
#   1. TypeScript — type-check across all workspaces
#   2. Lint       — ESLint on frontend
#   3. Tests      — full backend test suite (includes content validator)
#   4. Coverage   — engine must be exactly 100%
#
# Fails fast: first failure stops the run and exits non-zero.
# A passing run means the code is ready for adversarial review — not done.
# =============================================================================
...
# -----------------------------------------------------------------------------
printf "${C_CYAN}[1/4] TypeScript — all workspaces${C_RESET}\n"
...
# 2. Lint — frontend
# -----------------------------------------------------------------------------
printf "${C_CYAN}[2/4] Lint — frontend${C_RESET}\n"
...
# -----------------------------------------------------------------------------
# 3. Tests — backend (all suites)
# -----------------------------------------------------------------------------
printf "${C_CYAN}[3/4] Tests — backend${C_RESET}\n"
...
# -----------------------------------------------------------------------------
# 4. Engine coverage — must be 100%
# -----------------------------------------------------------------------------
printf "${C_CYAN}[4/4] Engine coverage — must be 100%%${C_RESET}\n"
...
printf "${C_CYAN}════════════════════════════════════════════════════${C_RESET}\n"
printf "\n${C_YELLOW}Reminder: passing checks ≠ done. Run adversarial self-review before declaring complete.${C_RESET}\n\n"
